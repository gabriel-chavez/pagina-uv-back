...
namespace UNIVidaPortalWeb.GatewayInterno
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                builder.WithOrigins("http://localhost:3000", "http://localhost:3001", "http://172.16.0.30:3000", "http://pagina-web.univida.bo:3000", "https://pagina-web.univida.bo:3000", "https://pagina.univida.bo", "http://192.168.13.59:3000", "http://172.16.0.30:5000", "http://172.16.0.30:5001")
                       .AllowAnyMethod()
                       .AllowAnyHeader()
