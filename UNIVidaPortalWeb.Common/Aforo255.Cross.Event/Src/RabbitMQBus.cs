...
namespace Aforo255.Cross.Event.Src
{
    public class RabbitMQBus : IEventBus
    {
        ...
        public void Publish<T>(T @event) where T : Aforo255.Cross.Event.Src.Events.Event
        {
        ...
        private void StartBasicConsume<T>() where T : Aforo255.Cross.Event.Src.Events.Event
        {
            var factory = new ConnectionFactory()
            {
                HostName = _options.Hostname,
